...
* Звонарева Дарья Александровна (ссылка на ваши соц сети)

## Выводы

Мы рассмотрели основные методы решения проблемы с недостающей информацией и классические методы выявления аномальных данных. Каждый из них имеет свои приимущества и недостатки, но грамотное комбинирование методов позволяет очистить исходные данные от "мусора" и подготовить их для последующего построения модели.
